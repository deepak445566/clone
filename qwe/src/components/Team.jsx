...
<h1 class="  text-3xl lg:text-5xl font-medium text-slate-800 text-center  mt-20">Meet Our Team</h1>
<p class="text-slate-500 text-center text-sm lg:text-lg">The people behind the product, passionate about what they do.</p>
<div class="flex flex-wrap items-center justify-center gap-6 mt-12">
    <div class="max-w-80 bg-black text-white rounded-2xl">
        <div class="relative -mt-px overflow-hidden rounded-2xl">
            <img src="/images/about1.jpg" alt="" class="h-[270px] w-[250px] rounded-2xl hover:scale-105 transition-all duration-300 object-cover object-top"/>
